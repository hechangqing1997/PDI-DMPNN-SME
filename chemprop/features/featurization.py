...
#             print(type(f_atoms[0]))
#             print(len(f_atoms[0]))
#             print(type(f_bonds[0]))
#             print(len(f_bonds[0]))
...
#             print('这个是self.n_atoms')
#             print(self.n_atoms)
#             print('这个是mol_graph.n_atoms')
#             print(mol_graph.n_atoms)
#             print('这个是self.n_bonds')
#             print(self.n_bonds)
#             print('这个是mol_graph.n_bonds')
#             print(mol_graph.n_bonds)
